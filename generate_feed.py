...
def _normalize_image_url(url: str) -> str:
    ...
    The CDN transform segment ("w_960,c_limit,q_auto,f_auto") is left alone,
    commas and all. It carries the resize instruction: without it the CDN
    serves the original full-resolution asset, which is slow enough that
    readers render the image late or, where a thumbnail is generated by
    fetching the image first, give up and show none at all.
...
SOURCES: tuple[Source, ...] = (
    ...
    Source(
        ...
        output_path="nike_launch_feed.xml",
